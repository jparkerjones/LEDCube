...
//LED values in cube.  indexed as follows: matrix[depth][row][column] = true for on, false for off
...
void loop() {
  ...
  if(matrix[val1][val1][val1])
  {
    matrix[val1][val1][val1] = false;
  }
  else
  {
    matrix[val1][val1][val1] = true;
  }
  
  if(matrix[val2][val2][val2 + 2])
  {
    matrix[val2][val2][val2 + 2] = false;
  }
  else
  {
    matrix[val2][val2][val2 + 2] = true;
  }

  if(matrix[val3+4][val3+4][val3])
  {
    matrix[val3+4][val3+4][val3] = false;
  }
  else
  {
    matrix[val3+4][val3+4][val3] = true;
  }
  ...
  /*
  //Iterate through all LEDs in matrix
  for(int i = 0; i < 8; i++)
  {
    for(int j =  0; j < 8; j++)
    {
